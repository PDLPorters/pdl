...
=head1 Using NiceSlice within the C<perldl> shell

Because the perldl shell uses evals, and NiceSlice is a perl source filter,
you have to set a special variable to use it within perldl.  See 
"Use in scripts and C<perldl> shell", below.
