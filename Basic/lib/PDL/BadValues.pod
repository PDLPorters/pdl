...
- C<PDL.bvals> (eg F<Basic/Core/pdlcore.h>); see also
C<typedef pdl_badvals> in F<Basic/Core/pdl.h.PL> and the
BOOT code of F<Basic/Core/Core.xs> where the values are initialised to
