...
Like all vectorized languages, PDL automates looping over multi-dimensional data structures ("piddles") using
...
that apply to piddles.  From the L<perldl> (or L<pdl2>) shell, you
...
'magically') generated by PDL based on the dimensions of the piddles
...
L<PDL::PP> compiled functions) and that the piddles are "threaded" over.
...
from each of its piddle arguments. The L<inner|PDL::Primitive/inner> function
