...
explicitly switched on dataflow in your ndarray by saying C<$x-E<gt>doflow>. For
...
routines (e.g. C<-E<gt>index(...)>) result in physical ndarrays.
...
I<diagonal> will be dimension no. C<i> of the new output ndarray and (if
