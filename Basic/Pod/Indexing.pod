...
that apply to piddles.  From the L<perldl|perldl> (or L<pdl2|pdl2>) shell, you
...
L<PDL::PP|PDL::PP> compiled functions) and that the piddles are "threaded" over.
