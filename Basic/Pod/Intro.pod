...
comes with a command line perl shell, called I<perldl>, which supports command
...
(lukka@husc.harvard.edu) and Christian Soeller (c.soeller@auckland.ac.nz) 1997 to 2000.
