...
C<CopyBadStatusCode> options to C<pp_def>.
...
Setting this key (e.g. C<Inplace =E<gt> 1>) marks the routine as working inplace.
...
Mark a function as being able to work inplace (use C<Inplace =E<gt> 1>).
