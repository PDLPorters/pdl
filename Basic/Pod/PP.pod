...
There is an XS F<typemap> entry (for C<PDL_Indx> and C<pdl*> array types for
...
arguments. This affects only the generated XS and C C<pdl_(name)_run>
...
=head4 Argument-handling change

Providing this also changes PP's argument handling: normally you can specify:
