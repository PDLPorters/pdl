...
Since this routine removes all bad values, then the output ndarray had
...
PDL functions allow you to pass in an ndarray into which you want the output
...
create new ndarrays on the fly, but only if you want them.
...
PP-generated function, you will need to supply all ndarrays in the exact
