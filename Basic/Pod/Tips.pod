...
PDL::Book::Tips - Small tidbits of useful arcana. Programming tidbits and such.
...
Use C<help help> within I<perldl> or the C<pdldoc> program from the
command line for access to the PerlDL documentation.
