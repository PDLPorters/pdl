...
The key differences between MATLAB and PDL are threading, and B<Perl>.

Threading means you can get a reference to just a part of your data,
...
A I<ndarray> consists of a series of numbers organized as an N-dimensional
...
L<PDL::Indexing>, L<PDL::Threading>,
and L<PDL::PP>.
...
It is important to note the difference between a I<ndarray> and a Perl
...
By comparison, the lack of "threading" means that to update the diagonal
