...
PDL::Book::FAQ - Frequently asked questions about PDL

=head1 VERSION

Current FAQ version:  0.94


=head1 DESCRIPTION

This is version  0.94 of the PDL FAQ, a collection of  frequently 
...
As of this writing (FAQ version 0.94 of 13 May 2010) the latest stable version
...
purposes and more general availability.  The second post-PDL-2.4.6 developers
release of PDL is available as CHM/PDL-2.4.6_006.tar.gz .
...
the win32/INSTALL file in the PDL source distribution for details.
...
might not always be the latest version.  PDL-2.4.6 builds out of
...
L<PDL::Indexing|PDL::Indexing> and especially
L<PDL::NiceSlice|PDL::NiceSlice> ).

Finally, to confuse you completely, you can have perl arrays
of pdls, e.g. C< $spec[3]> can refer to a pdl representing ,e.g,
...
released version of PDL 2.4.3 [ What about 2.4.6? ].
