...
Current FAQ version:  0.93


=head1 DESCRIPTION

This is version  0.93 of the PDL FAQ, a collection of  frequently 
...
As of this writing (FAQ version 0.93 of 01 Jan 2010) the latest stable version
is 2.4.6.  The latest stable version should always be available from a CPAN
...
purposes and more general availability.  The second PDL-2.4.6 prerelease candidate
is available via git or as a CPAN developers release: CHM/PDL-2.4.5_008.tar.gz .
...
using lvalue subroutines:
            ...
            perldl> $a->slice('1:2') .= pdl([5,6])
            perldl> p $a
               [0 5 6 3 4]

see L<PDL::Lvalue> for more info.  
...
There are also C<3dtest.pl> and C<line3d.pl> in the PDL/Example/TriD
