...
This is version  0.7 of the PDL FAQ, a collection of  frequently 
...
C< me@my.email.address> with your email address. A searchable archive 
and a hypertext version of the traffic on this list (1997-2004) can be 
found at http://www.xray.mpe.mpg.de/mailing-lists/perldl/ . More
recent messages (since June 2005) can be found at 
...
where you should replace the string C< me@my.email.address> 
with your email address. A searchable archive and a hypertext version
...
nearing release. The latest stable version
should always be available from a CPAN mirror site near you (see 
L<Question 2.7|"Q: 2.7    Where do I get it?"> for info on where to
get PDL.
