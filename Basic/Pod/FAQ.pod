...
Current FAQ version:  0.95


=head1 DESCRIPTION

This is version  0.95 of the PDL FAQ, a collection of  frequently 
...
the PDL on-line help facility from within the 
C< perldl> shell. Just
type 
...
As of this writing (FAQ version 0.95 of 19 July 2010) the latest stable version
...
purposes and more general availability.  The current post-PDL-2.4.6 developers
release of PDL is available as CHM/PDL-2.4.6_015.tar.gz .
...
interface can be specified. See the man page for
details. 
...
the L<PDL::PP|PDL::PP> man page and
...
The L<PDL::PP|PDL::PP> man page is the main
...
with the PDL::PP man page this should allow you to quickly
...
PDL and on-line help                           

=item *

sub-classing piddles                           
...
questions about piddles and perl array syntax 
