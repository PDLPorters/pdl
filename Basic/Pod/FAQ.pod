...
Current FAQ version:  0.97


=head1 DESCRIPTION

This is version  0.97 of the PDL FAQ, a collection of  frequently 
...
As of this writing (FAQ version 0.97 of 07 March 2011) the latest stable version
is 2.4.7.  The latest stable version should always be available from a CPAN
...
L<http://pdl.perl.orgL> .  At present there are binary distributions 
...
might not always be the latest version.  PDL-2.4.7 builds out of
