...
Current FAQ version:  0.9


=head1 DESCRIPTION

This is version  0.9 of the PDL FAQ, a collection of  frequently 
...
As of this writing (FAQ version 0.9 of May 2009) the latest version is 2.4.4. 
The latest stable version should always be available
...
command line
   ...
   git clone ssh://USERNAME@pdl.git.sourceforge.net/gitroot/pdl PDL
