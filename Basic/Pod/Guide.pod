...
PDL::Guide - A journey through PDL's documentation, from beginner to
advanced.
...
related?  Where should you begin? Hopefully this document will
give you a good starting place for learning more about PDL. My
hope is that somebody new to PDL could read the PDL documentation
in the order recommended in this document and get a firm grasp of
the library's capabilities without getting too terribly lost.
...
An alternative to this document is L<PDL::Index|PDL::Index>, which is automatically
...
=item * L<PDL::Intro|PDL::Intro>, L<PDL::QuickStart|PDL::QuickStart>, L<PDL::Philosophy|PDL::Philosophy>
...
=item * The L<perldl|perldl> Shell
...
=item * L<PDL::ImageRBG|PDL::ImageRBG>
