...
PDL::Migration::Scilab - A guide for Scilab users.
...
supported by N-dimensional piddles. There is usually no distinction:
  ...
  Scilab                       PerlDL
  ------                       ------
  --> A = ones(3,3,3);         perldl> $A = ones(3,3,3);
  --> A'                       perldl> transpose $A
      => ERROR                         => OK
...
PDL has powerful plotting abilities. Unlike Scilab, PDL relies more on
