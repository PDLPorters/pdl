...
Also double(), short(), ushort().  The indx() routine is
for a PDL index value which is either a 32bit or 64bit
quantity depending on whether your perl is 32bit or 64bit.
