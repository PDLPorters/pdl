...
The members at the end are part of the "compiled representation"
(generated by L<PDL::PP>), and are the way that information like
...
with C<NP> depending on the number of ndarray args of the particular
