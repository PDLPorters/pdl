...
eval { $spl->eval(10)     }; isnt($@,'', 'eval 10 (extrapolation not allowed)') ;
eval { $spl->deriv(10)    }; isnt($@,'', 'deriv 10 (extrapolation not allowed)' );
eval { $spl->deriv2(10)   }; isnt($@,'', 'deriv2 10 (extrapolation not allowed)');
eval { $spl->integ(8.5,10)}; isnt($@,'', 'integ 8.5 to 10 (extrapolation not allowed)');
...
isnt($@,'',"module exception handling");
