...
scalar variable C<$x> can now be a user-defined data type or full blown
...
There are also a lot of extension modules, eg L<PDL::Graphics::TriD>.
...
allows the argument to be modified. eg:
