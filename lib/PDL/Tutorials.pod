...
=item L<PDL::Guide::Migration::NumPy>

Migration guide for NumPy users. This page explains the key differences
between NumPy and PDL from the point of view of a NumPy user.

=item L<PDL::Guide::Migration::MATLAB>
...
=item L<PDL::Guide::Migration::Scilab>
