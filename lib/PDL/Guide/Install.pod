...
PDL::Guide::Install - installation notes for PDL
...
have a recent enough version of Perl: 5.16.0 and above
is required (or see L<MetaCPAN|https://metacpan.org/dist/PDL> for
the most recent Perl version requirement).
