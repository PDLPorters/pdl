...
For fuzzy searching within I<perldl>, use the C<apropos> command
to find all instances of the search term in the documentation.
See L<PDL::FAQ> Q:7.1 for an example.
...
forgotten. It is like C<copy> except it changes the original ndarray
and returns it.
