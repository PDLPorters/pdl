...
L<PDL::DeveloperGuide> - How to develop for PDL
...
L<PDL::Guide::Migration::MATLAB> - A guide for MATLAB users.

=item *

L<PDL::Guide::Migration::NumPy> - A Rosetta Stone for the NumPy professional

=item *

L<PDL::Guide::Migration::Scilab> - A guide for Scilab users.

=item *

L<PDL::IO> - An overview of some modules in the PDL::IO namespace.
...
L<PDL::InstallGuide> - installation notes for PDL
...
L<PDL::Objects> - Object-orientation, what it is and how to exploit it
...
L<PDL::Type> - Objects encapsulating datatypes for PDL transformations
...
L<pdldoc> - shell interface to PDL documentation
...
L<PDL::Config> - vestige of configuration for PDL
...
L<PDL::IO::Storable> - helper functions to make PDL usable with serialisation packages
...
L<PDL::Install::Files> - Module for use by ExtUtils::Depends and Inline
...
L<PDL::Parallel::threads> - sharing PDL data between Perl threads

=item *

L<PDL::Parallel::threads::SIMD> - launch and synchronize Single-Instruction-Multiple-Dataset code
...
L<PDL::Reduce> - a reduce function for PDL
...
Automatically generated by scantree.pl for PDL version 2.104.
